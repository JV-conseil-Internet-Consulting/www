...
_asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
  ...
  return _regeneratorRuntime().wrap(function _callee$(_context) {
    while (1) switch (_context.prev = _context.next) {
      case 0:
        _context.next = 2;
        return _common__WEBPACK_IMPORTED_MODULE_3__.stylesheetReady;
      case 2:
        pushStateEl = document.getElementById('_pushState');
        searchFrag = (0,_common__WEBPACK_IMPORTED_MODULE_3__.importTemplate)('_search-template');
      ...
      case 17:
        ...
        _context.next = 25;
        return (0,_common__WEBPACK_IMPORTED_MODULE_3__.once)(document, 'click');
      case 25:
        /**
        ...
        worker = new Worker( /* webpackChunkName: "search-worker" */new URL(/* worker import */ __webpack_require__.p + __webpack_require__.u("search-worker"), __webpack_require__.b));
        (0,_common__WEBPACK_IMPORTED_MODULE_3__.postMessage)(worker, window._search);
        prevVal = '';
        (0,rxjs__WEBPACK_IMPORTED_MODULE_4__.fromEvent)(searchInputEl, 'keyup').pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_5__.tap)(function (e) {
          if (e.target.value === '' && prevVal === '' && e.keyCode === 27) {
            e.preventDefault();
            closeHandler();
          }
          prevVal = e.target.value;
        }), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_6__.switchMap)(function (e) {
          return (0,_common__WEBPACK_IMPORTED_MODULE_3__.postMessage)(worker, e.target.value);
        }), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_5__.tap)(function (items) {
          if (items.length) {
