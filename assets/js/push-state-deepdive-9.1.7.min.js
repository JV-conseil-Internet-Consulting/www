...
function setupFLIP(start$, ready$, fadeIn$, options) {
  var other$ = start$.pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_1__.filter)(function (_ref) {
    var flipType = _ref.flipType;
    return !FLIP_TYPES.includes(flipType);
  }));
  return (0,rxjs__WEBPACK_IMPORTED_MODULE_2__.merge)((0,_title__WEBPACK_IMPORTED_MODULE_0__.setupFLIPTitle)(start$, ready$, fadeIn$, options), other$);
}
...
/* harmony import */ var rxjs__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! rxjs */ "./node_modules/rxjs/dist/esm5/internal/lastValueFrom.js");
...
/* harmony import */ var rxjs_operators__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! rxjs/operators */ "./node_modules/rxjs/dist/esm5/internal/operators/exhaustMap.js");
    ...
    while (1) switch (_context.prev = _context.next) {
      ...
      case 15:
        ...
        animateFadeIn = function animateFadeIn(_ref3) {
          ...
          return (0,_common__WEBPACK_IMPORTED_MODULE_0__.animate)(main, FADE_IN, settings).pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_3__.map)(function () {
            main, flipType;
          }));
        };
        ...
        fromEventX = function fromEventX(eventName, mapFn) {
          return (0,rxjs__WEBPACK_IMPORTED_MODULE_4__.fromEvent)(pushStateEl, eventName).pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_3__.map)(function (_ref4) {
            var detail = _ref4.detail;
            return detail;
          }), mapFn ? (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_3__.map)(mapFn) : function (_) {
            return _;
        ...
        fadeOut$ = start$.pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_3__.map)(function (context) {
          return Object.assign(context, {
            main: document.getElementById('_main')
          });
        }), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_6__.tap)(function (_ref5) {
          var main = _ref5.main;
          main.style.pointerEvents = 'none';
        }), window._noDrawer && drawerEl !== null && drawerEl !== void 0 && drawerEl.classList.contains('cover') ? (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_6__.tap)(function () {
          ...
          return _;
        }, (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_7__.exhaustMap)(animateFadeOut), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_6__.tap)(function (_ref6) {
          var main = _ref6.main;
        ...
        fadeIn$ = after$.pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_8__.switchMap)(function (context) {
          // const p = animateFadeIn(context).toPromise();
          var p = (0,rxjs__WEBPACK_IMPORTED_MODULE_9__.lastValueFrom)(animateFadeIn(context));
        ...
        flip$ = (0,_flip__WEBPACK_IMPORTED_MODULE_2__.setupFLIP)(start$, ready$, (0,rxjs__WEBPACK_IMPORTED_MODULE_10__.merge)(fadeIn$, error$), {
          ...
          settings: settings
        }).pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_5__.share)());
        start$.pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_8__.switchMap)(function (context) {
          // const promise = zip(timer(duration), fadeOut$, flip$).toPromise();
          var promise = (0,rxjs__WEBPACK_IMPORTED_MODULE_9__.lastValueFrom)(animateFadeIn((0,rxjs__WEBPACK_IMPORTED_MODULE_11__.zip)((0,rxjs__WEBPACK_IMPORTED_MODULE_12__.timer)(duration), fadeOut$, flip$)));
        ...
        if (sidebarBg) {
          ...
          after$.pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_8__.switchMap)(function (_ref7) {
            var document = _ref7.document;
            return (0,rxjs__WEBPACK_IMPORTED_MODULE_11__.zip)(crossFader.fetchImage(document), fadeIn$).pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_3__.map)(function (_ref8) {
        ...
        error$.pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_8__.switchMap)(function (_ref12) {
          var url = _ref12.url;
