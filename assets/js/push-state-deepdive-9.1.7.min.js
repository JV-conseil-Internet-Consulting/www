...
function setupFLIP(start$, ready$, fadeIn$, options) {
  var other$ = start$.pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_1__.filter)(_ref => {
    var {
      flipType
    } = _ref;
...
_asyncToGenerator(function* () {
  ...
  var animateFadeIn = _ref3 => {
    ...
    return (0,_common__WEBPACK_IMPORTED_MODULE_0__.animate)(main, FADE_IN, settings).pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_3__.map)(() => {
      main, flipType;
    }));
  };
  ...
  var fromEventX = (eventName, mapFn) => (0,rxjs__WEBPACK_IMPORTED_MODULE_4__.fromEvent)(pushStateEl, eventName).pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_3__.map)(_ref4 => {
    var {
      detail
    } = _ref4;
    return detail;
  }), mapFn ? (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_3__.map)(mapFn) : _ => _, (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_5__.share)());
  ...
  var fadeOut$ = start$.pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_3__.map)(context => Object.assign(context, {
    main: document.getElementById('_main')
  })), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_6__.tap)(_ref5 => {
    var {
      main
    } = _ref5;
    main.style.pointerEvents = 'none';
  }), window._noDrawer && drawerEl !== null && drawerEl !== void 0 && drawerEl.classList.contains('cover') ? (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_6__.tap)(() => {
  ...
  }) : _ => _, (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_7__.exhaustMap)(animateFadeOut), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_6__.tap)(_ref6 => {
    var {
      main
    } = _ref6;
  ...
  var fadeIn$ = after$.pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_8__.switchMap)(context => {
  ...
  start$.pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_8__.switchMap)(context => {
  ...
  if (sidebarBg) {
    ...
    after$.pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_8__.switchMap)(_ref7 => {
      var {
        document
      } = _ref7;
      return (0,rxjs__WEBPACK_IMPORTED_MODULE_11__.zip)(crossFader.fetchImage(document), fadeIn$).pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_3__.map)(_ref8 => {
        var [x] = _ref8;
        return x;
  ...
  error$.pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_8__.switchMap)(_ref10 => {
    var {
      url
    } = _ref10;
