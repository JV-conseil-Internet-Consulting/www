...
/* harmony import */ var kv_storage_polyfill__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! kv-storage-polyfill */ "./node_modules/kv-storage-polyfill/dist/kv-storage-polyfill.mjs");
...
var relativeUrl = function relativeUrl(url) {
  return url.startsWith(window._baseURL) ? url : join(window._baseURL, url);
};
  ...
  return _regeneratorRuntime().wrap(function _callee$(_context) {
    while (1) switch (_context.prev = _context.next) {
      ...
      case 2:
        ...
        searchFrag = (0,_common__WEBPACK_IMPORTED_MODULE_4__.importTemplate)('_search-template');
      ...
      case 17:
        ...
        _context.next = 25;
        return (0,_common__WEBPACK_IMPORTED_MODULE_4__.once)(document, 'click');
      case 25:
        /**
        ...
        worker = new Worker(new URL(/* asset import */ __webpack_require__(/*! ./search.worker.js */ "./_js/src/search.worker.js"), __webpack_require__.b));
        (0,_common__WEBPACK_IMPORTED_MODULE_4__.postMessage)(worker, window._search);
        prevVal = '';
        (0,rxjs__WEBPACK_IMPORTED_MODULE_5__.fromEvent)(searchInputEl, 'keyup').pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_6__.tap)(function (e) {
          if (e.target.value === '' && prevVal === '' && e.keyCode === 27) {
            e.preventDefault();
            closeHandler();
          }
          prevVal = e.target.value;
        }), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_7__.switchMap)(function (e) {
          return (0,_common__WEBPACK_IMPORTED_MODULE_4__.postMessage)(worker, e.target.value);
        }), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_6__.tap)(function (items) {
          if (items.length) {
            (0,lit_html_js__WEBPACK_IMPORTED_MODULE_0__.render)((0,lit_html_js__WEBPACK_IMPORTED_MODULE_0__.html)(_templateObject || (_templateObject = _taggedTemplateLiteral(["\n                <ul>\n                  ", "\n                </ul>\n              "])), (0,lit_directives_repeat_js__WEBPACK_IMPORTED_MODULE_1__.repeat)(items, function (item) {
              return item.url;
            }, function (item) {
              return (0,lit_html_js__WEBPACK_IMPORTED_MODULE_0__.html)(_templateObject2 || (_templateObject2 = _taggedTemplateLiteral(["\n                      <li class=\"search-item\" @click=", ">\n                        <div class=\"search-img aspect-ratio sixteen-ten\">\n                          ", "\n                        </div>\n                        <div class=\"search-text\">\n                          <p>\n                            <a class=\"heading\" href=", " tabindex=\"1\">", "</a>\n                            <small>", "</small>\n                          </p>\n                          ", "\n                        </div>\n                      </li>\n                    "])), function () {
...
module.exports = __webpack_require__.p + "cdef798ed1ac3f4faae6.js";
